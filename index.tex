...
\startsectionlevel[title={Dene Farrell},reference={dene-farrell}]

\thinrule

\startblockquote
{\bf \goto{github}[url(https://github.com/dfarrel1)]} \letterbar{} {\bf
\goto{linkedIn}[url(https://www.linkedin.com/in/denefarrell/)]}
\letterbar{} {\bf \goto{resume}[url(https://dfarrel1.github.io/)]}
\stopblockquote

\thinrule

{\bf Professional Summary}\crlf
...
{\bf \goto{Defense Digital Service}[url(https://www.dds.mil/)]} -
Digital Service Expert\crlf
...
\item
  ...
  response support in partnership between DDS and the State Department.
  Contributed to larger team efforts by rapidly deploying underlying
  cloud infrastructure for future application development and
  deployment.
\stopitemize

{\bf \goto{Latch}[url(https://www.latch.com/)]} - Senior Manager, Data
Engineering\crlf
...
{\bf \goto{Capital One}[url(https://www.capitalone.com/tech/)]} -
Principal Data Engineer\crlf
...
{\bf \goto{Insight Fellows Program}[url(https://insightfellows.com/)]} -
Data Engineering Fellow\crlf
...
{\bf \goto{Sloan Kettering
Institute}[url(https://www.mskcc.org/research/ski/labs/jennifer-zallen)]}
- Software Engineer\crlf
...
\startsectionlevel[title={Side Projects},reference={side-projects}]
...
\startdescription{Programming Languages}
  {\bf Python:} 10 Years experience.

  {\bf Scala, Java:} 3 years experience developing in Scala and Java.
  ...
  {\bf Shell (Bash):}
  e.g.~\goto{dots}[url(https://github.com/dfarrel1/dots)]

  Basic knowledge:\crlf
  {\bf C++}, {\bf D3}, {\bf Mathematica}, {\bf Matlab}, {\bf Perl}
\stopdescription
...
\startblockquote
\goto{dene.farrell@gmail.com}[url(mailto:dene.farrell@gmail.com)] •
...
\startblockquote
\goto{pdf}[url(https://dfarrel1.github.io/index.pdf)] •
\goto{txt}[url(https://dfarrel1.github.io/index.txt)] •
\goto{doc}[url(https://dfarrel1.github.io/index.docx)] •
\goto{web}[url(https://dfarrel1.github.io/)] •
\goto{generator}[url(https://github.com/dfarrel1/dfarrel1.github.io/)] •
\goto{one-page}[url(https://dfarrel1.github.io/one-page/2021-June/Dene-Farrell-resume-2021-June-onepage.pdf)]
•
\goto{cv+publications}[url(https://dfarrel1.github.io/one-page/2021-June/Dene-Farrell-CV-2021-June.pdf)]
\stopblockquote
