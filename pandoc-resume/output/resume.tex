...
\item
  Delivered several cross-company microservices: Data Centralization and
...
\startblockquote
\useURL[url2][./resume.pdf][][pdf]\from[url2] •
\useURL[url3][./resume.txt][][txt]\from[url3] •
\useURL[url4][./resume.docx][][doc]\from[url4]
\stopblockquote
